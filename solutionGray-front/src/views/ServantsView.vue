<template>
    <section class="h-screen p-8 container">
      <div class="mb-6 container">
        <p class="text-primary-900 text-3xl font-serif"><strong> Rogad, pues, al Señor de la mies, que envíe obreros a su mies. Mateo 9:38</strong></p>
      </div>
      <div class="p-2 shadow-md bg-second-50 shadow-second-600 rounded-md h-auto">
        <h1 class="text-5xl mb-4 text-second-800"><strong>Servidores</strong></h1>
        ...
        <div v-if="loading" class="p-6 space-y-4">
          ...
          >           
            ...
            <Column field="last_service" header="Fecha de Ultimo Servicio" class="p-4 text-center border-b  border-primary-200 text-second-800">
              <template #body="slotProps">
          ...
          <Column field="last_course" header="Ultimo Curso" class="p-4 text-center border-b  border-primary-200 text-second-800">
            <template #body="slotProps">
            ...
            <Column field="status_course" header="Estado del Curso" class="p-4 text-center border-b  border-primary-200 text-second-800">
            <template #body="slotProps">

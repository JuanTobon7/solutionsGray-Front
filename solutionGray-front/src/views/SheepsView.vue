    ...
    <section class="h-screen p-8 container">
      ...
      <div class="p-2 shadow-md bg-second-50 shadow-second-600 rounded-md h-auto">
        ...
        <div class="p-6">
          ...
          <Column field="last_visit" header="Ultima Visita" class="p-4 text-left border-b  border-primary-200 text-second-800">
            <template #body="slotProps">
            ...
            <Column field="status" header="Status" class="p-4 text-left border-b  border-primary-200 text-second-800">
            <template #body="slotProps">
                <Tag :value="slotProps.data.status" class="p-2 text-left border-b rounded-md bg-green-200 text-green-900 uppercase">
